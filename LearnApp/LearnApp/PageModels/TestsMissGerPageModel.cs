...
{
    public class TestsMissGerPageModel : PageModelBase
    {
        #region Properties
        ...
        public TestsMissGerPageModel(INavigationService navigationService, GameManager game)
        {
        ...
        async Task Selected(object args)
        {
            ...
            SelectedTest = null;
            await App.Current.MainPage.Navigation.PushAsync(new NavigationPage(new LearnApp.Pages.MissBegin(ref test)));
