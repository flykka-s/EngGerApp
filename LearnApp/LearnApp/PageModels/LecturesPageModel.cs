...
namespace LearnApp.PageModels
{
    public class LecturesPageModel : PageModelBase
    {
        ...
        async Task Selected(object args)
        {
           ...
           await App.Current.MainPage.Navigation.PushAsync(new NavigationPage(new LearnApp.Pages.LectureP(ref lec, "eng")));
        ...
        async void LoadMore()
        {
                ...
                LectureGroups.Add(new Grouping<string, Lecture>("", Lecture.Where(c => c.Chapter == "Глава 1")));
