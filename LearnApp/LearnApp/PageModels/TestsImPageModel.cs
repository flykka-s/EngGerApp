...
{
    public class TestsImPageModel : PageModelBase
    {
        #region Properties
        ...
        public TestsImPageModel(INavigationService navigationService, GameManager game)
        {
        ...
        async void LoadMore()
        {
            ...
            TestGroups.Add(new Grouping<string, ImTest>("Глава 1", Test.Where(c => c.Chapter == "Глава 1")));
