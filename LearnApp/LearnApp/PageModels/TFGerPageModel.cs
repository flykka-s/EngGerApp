...
{
    public class TFGerPageModel : PageModelBase
    {
        #region Properties
        ...
        #endregion
        public ObservableRangeCollection<TF> Test { get; set; }
        public ObservableRangeCollection<Grouping<string, TF>> TestGroups { get; }

        public AsyncCommand RefreshCommand { get; }

        public AsyncCommand<TF> FavoriteCommand { get; }
        ...
        public TFGerPageModel()
        {

            Title = "Title H1";

            Test = new ObservableRangeCollection<TF>();
            TestGroups = new ObservableRangeCollection<Grouping<string, TF>>();

            LoadMore();

            RefreshCommand = new AsyncCommand(Refresh);
            FavoriteCommand = new AsyncCommand<TF>(Favorite);
        ...
        public TFGerPageModel(INavigationService navigationService, GameManager game)
        {
        ...
        async Task Selected(object args)
        {
            ...
            SelectedTest = null;
            await App.Current.MainPage.Navigation.PushAsync(new NavigationPage(new LearnApp.Pages.TFBeg(ref test)));
        ...
        async void LoadMore()
        {
            ...
            Test = await TFData.GetDataAsync();
            TestGroups.Clear();

            TestGroups.Add(new Grouping<string, TF>("Глава 1", Test.Where(c => c.Chapter == "Глава 2")));
