...
{
    public class TaskGerPPageModel : PageModelBase
    {
        ...
        public TaskGerPPageModel(INavigationService navigationService, IAccountService accountService)
        {
        ...
        async void LoadMore()
        {
            ...
            //TaskGroups.Add(new Grouping<string, Task_>("Глава 1", Task_.Where(c => c.Chapter == "Глава 1")));
