...
{
    public class TFPageModel : PageModelBase
    {
        #region Properties
        ...
        public TFPageModel(INavigationService navigationService, GameManager game)
        {
        ...
        async void LoadMore()
        {
            ...
            TestGroups.Add(new Grouping<string, TF>("Глава 1", Test.Where(c => c.Chapter == "Глава 1")));
