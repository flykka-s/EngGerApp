...
{
    public class OnCollectionCompleteListenerImTests<T> : Java.Lang.Object, IOnCompleteListener 
        where T : IIdentifiableImTests
    {
       
            private System.Threading.Tasks.TaskCompletionSource<IList<T>> _tcs;

            public OnCollectionCompleteListenerImTests(System.Threading.Tasks.TaskCompletionSource<IList<T>> tcs)
            {
                _tcs = tcs;
            }
