...
{
    public class OnCollectionCompleteListenerTF<T> : Java.Lang.Object, IOnCompleteListener 
        where T : IIdentifiableTF
    {
       
            private System.Threading.Tasks.TaskCompletionSource<IList<T>> _tcs;

            public OnCollectionCompleteListenerTF(System.Threading.Tasks.TaskCompletionSource<IList<T>> tcs)
            {
                _tcs = tcs;
            }
