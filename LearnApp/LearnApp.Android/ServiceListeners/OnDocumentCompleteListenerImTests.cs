...
{
    public class OnDocumentCompleteListenerImTests<T> : Java.Lang.Object, IOnCompleteListener
         where T : IIdentifiableImTests
    {
        private TaskCompletionSource<T> _tcs;

        public OnDocumentCompleteListenerImTests(TaskCompletionSource<T> tcs)
        {
            _tcs = tcs;
        }
