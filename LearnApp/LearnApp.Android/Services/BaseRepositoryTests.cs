...
{
    public abstract class BaseRepositoryTests<T> : IRepositoryTests<T> where T : IIdentifiableTests
    {
        ...
        public Task<bool> Delete(T item)
        {
            ...
            FirebaseFirestore.Instance
                ...
                .Document(item.Id)
                .Delete()
                .AddOnCompleteListener(new OnDeleteCompleteListenerTest(tcs));
        ...
        public Task<IList<T>> GetAll()
        {
            ...
            FirebaseFirestore.Instance
             .Collection(DocumentPath)
             .Get()
             .AddOnCompleteListener(new OnCollectionCompleteListenerTests<T>(tcs));
        ...
        public Task<T> Get(string id)
        {
            ...
            FirebaseFirestore.Instance
                ...
                .Document(id)
                .Get()
                .AddOnCompleteListener(new OnDocumentCompleteListenerTests<T>(tcs));
            return tcs.Task;
        }
