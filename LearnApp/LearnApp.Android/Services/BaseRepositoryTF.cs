...
{
    public abstract class BaseRepositoryTF<T> : IRepositoryTF<T> where T : IIdentifiableTF
    {
        ...
        public Task<bool> Delete(T item)
        {
            ...
            FirebaseFirestore.Instance
                ...
                .Document(item.Id)
                .Delete()
                .AddOnCompleteListener(new OnDeleteCompleteListenerTF(tcs));
        ...
        public Task<IList<T>> GetAll()
        {
            ...
            FirebaseFirestore.Instance
             .Collection(DocumentPath)
             .Get()
             .AddOnCompleteListener(new OnCollectionCompleteListenerTF<T>(tcs));
        ...
        public Task<T> Get(string id)
        {
            ...
            FirebaseFirestore.Instance
                ...
                .Document(id)
                .Get()
                .AddOnCompleteListener(new OnDocumentCompleteListenerTF<T>(tcs));
            return tcs.Task;
        }
