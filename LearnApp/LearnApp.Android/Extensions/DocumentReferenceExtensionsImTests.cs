...
{
    public static class DocumentReferenceExtensionsImTests
    {
        public static T Convert<T>(this DocumentSnapshot doc) where T : IIdentifiableImTests
        {
            try
            {
        ...
        public static List<T> Convert<T>(this QuerySnapshot docs) where T : IIdentifiableImTests
        {
            var list = new List<T>();
