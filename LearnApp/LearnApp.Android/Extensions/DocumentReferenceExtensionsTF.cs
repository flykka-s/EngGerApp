...
{
    public static class DocumentReferenceExtensionsTF
    {
        public static T Convert<T>(this DocumentSnapshot doc) where T : IIdentifiableTF
        {
            try
            {
        ...
        public static List<T> Convert<T>(this QuerySnapshot docs) where T : IIdentifiableTF
        {
            var list = new List<T>();
