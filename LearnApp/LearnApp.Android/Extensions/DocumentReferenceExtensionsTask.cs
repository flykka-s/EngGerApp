...
{
    public static class DocumentReferenceExtensionsTask
    {
        public static T Convert<T>(this DocumentSnapshot doc) where T : IIdentifiableTask
        {
            try
            {
        ...
        public static List<T> Convert<T>(this QuerySnapshot docs) where T : IIdentifiableTask
        {
            var list = new List<T>();
